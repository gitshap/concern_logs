...
from concerns.views import  create_concern, create_concern_form, concern_detail,update_concern, delete_concern, home

urlpatterns = [
    path('create_concern/', create_concern, name='create-concern'),
    path('home/', home, name='home'),
    path('htmx/create-book-form/', create_concern_form, name='create-concern-form'),
